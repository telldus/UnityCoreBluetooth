...
SWIFT_EXTERN void ucb_characteristic_write(CBCharacteristic * _Nonnull const * _Nonnull characteristic, uint8_t const * _Nullable value, long len);

@class CBPeripheral;

SWIFT_EXTERN void ucb_manager_shared_connectWithPeripheral(CBPeripheral * _Nonnull const * _Nonnull peripheral);


SWIFT_EXTERN void ucb_manager_shared_instantiate(void);
...
SWIFT_EXTERN void ucb_manager_shared_register_onUpdateValue(void (* _Nonnull handler)(CBCharacteristic * _Nonnull const * _Nonnull, uint8_t const * _Nonnull, long));


SWIFT_EXTERN void ucb_manager_shared_release(void);


SWIFT_EXTERN void ucb_manager_shared_startScan(void);


SWIFT_EXTERN void ucb_manager_shared_stopScan(void);


SWIFT_EXTERN void ucb_peripheral_discoverServicesWithPeripheral(CBPeripheral * _Nonnull const * _Nonnull peripheral);
...
SWIFT_EXTERN char const * _Nullable ucb_service_getUuid(CBService * _Nonnull const * _Nonnull service) SWIFT_WARN_UNUSED_RESULT;
